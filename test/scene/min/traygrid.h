...
*/
#ifndef __TESTRAYGRID__
#define __TESTRAYGRID__
...
bool test_ray_grid()
{
    ...
    // vec2 aabb grid
    {
        ...
        min::grid<double, uint16_t, uint32_t, min::vec2, min::aabbox, min::aabbox> g(world);
    ...
    // vec2 oobb grid
    {
        ...
        min::grid<double, uint16_t, uint32_t, min::vec2, min::oobbox, min::oobbox> g(world);
    ...
    // vec3 aabb grid
    {
        ...
        min::grid<double, uint16_t, uint32_t, min::vec3, min::aabbox, min::aabbox> g(world);
    ...
    // vec3 oobb grid
    {
        ...
        min::grid<double, uint16_t, uint32_t, min::vec3, min::oobbox, min::oobbox> g(world);
    ...
    // vec4 aabb grid
    {
        ...
        min::grid<double, uint16_t, uint32_t, min::vec4, min::aabbox, min::aabbox> g(world);
    ...
    // vec4 oobb grid
    {
        ...
        min::grid<double, uint16_t, uint32_t, min::vec4, min::oobbox, min::oobbox> g(world);
