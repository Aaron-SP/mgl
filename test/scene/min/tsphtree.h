...
bool test_sphere_tree()
{
    ...
    // vec2 tree
    {
        ...
        min::tree<double, uint16_t, uint32_t, min::vec2, min::sphere, min::sphere> t(world);
    ...
    // vec3 tree
    {
        ...
        min::tree<double, uint16_t, uint32_t, min::vec3, min::sphere, min::sphere> t(world);
    ...
    // vec4 tree
    {
        ...
        min::tree<double, uint16_t, uint32_t, min::vec4, min::sphere, min::sphere> t(world);
